...
if(isset($_SESSION['userConectado'])){
	if($_SESSION['isAdmin'] == true){
		...
		if ($permInfo['getGiveAdmin'] == 1) {
			...
			$con->_query("UPDATE usuarios SET grupo='0' WHERE id = '$id'");
			$con->_addLog($userID, "Removeu o administrador " . $nick ." com sucesso.", 'Administradores' );
			...
			$con->_addLog($userID, "Tentou removeu um administrador, mas o mesmo não tem permissão.", 'Administradores' );
		}
	}else{
